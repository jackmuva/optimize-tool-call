...
with open('./results/claude-sys-prompt-1-results.json') as f:
    prompt_1_dict = json.load(f)
with open('./results/claude-sys-prompt-2-results.json') as f:
    prompt_2_dict = json.load(f)
with open('./results/claude-llm-results.json') as f:
    prompt_0_dict = json.load(f)

prompt_1_data = pd.read_csv('./data/claude-sys-prompt-1-axis-dataset.csv').to_dict()
prompt_2_data = pd.read_csv('./data/claude-sys-prompt-2-axis-dataset.csv').to_dict()
prompt_0_data = pd.read_csv('./data/claude-llm-axis-dataset.csv').to_dict()
...
results_table.to_csv('./results/sys-prompt-comparison-table.csv')
